...
let _ = spawn(66.440674).x(-171.24123).y(-156.56258).z(0).ry(66.440674).rot(1.343667).mass(293293.28).inertia(293293.28).vx(-0.6317834).vy(0.6240093).va(-0.25652564).restitution(0.95).lindamp(0).angdamp(0).h(0).s(1).l(1).a(1).sides(32).cmx(0).cmy(0).friction(0).tail(90).layer(0).dynamic(true).sensor(false).links("").code_i("").code_f("");
let _ = spawn(7.056332).x(-98.76889).y(-155.83301).z(0).ry(7.056332).rot(-0.6896148).mass(351.34766).inertia(351.34766).vx(296.98438).vy(101.42469).va(-149.56653).restitution(0.95).lindamp(0).angdamp(0).h(200).s(1).l(0.6352941).a(1).sides(32).cmx(0).cmy(0).friction(0.5).tail(90).layer(0).dynamic(true).sensor(false).links("").code_i("s2 += 1;
